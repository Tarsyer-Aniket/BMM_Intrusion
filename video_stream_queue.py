...
class VideoStreamQueue:
	def __init__(self, VIDEO_INPUT, SKIP_FRAME=5, queue_size=16):
		...
		VSQ_LOG_PATH = '/tmp/processing.log'
			...
			if not self.Q.full():
				...
				if counter < self.SKIP_FRAME:
					...
					if grabbed and frame is not(None):
						...
						crop = frame[300:1440, 1000:2140]
						image_300 = cv2.resize(crop, tuple(INPUT_SHAPE))
